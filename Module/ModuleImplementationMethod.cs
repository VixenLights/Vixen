...
namespace Vixen.Module {
	abstract class ModuleImplementationMethod {
		public object Instance { get; protected set; }
		public object Result { get; protected set; }

		abstract public void Invoke(params object[] parameters);
	}

	class ModuleImplementationMethod<T> : ModuleImplementationMethod {
