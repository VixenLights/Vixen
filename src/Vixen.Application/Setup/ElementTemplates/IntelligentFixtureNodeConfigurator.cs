...
{
	/// <summary>
	/// Configures and intelligent fixture node with properties.
	/// </summary>
	/// <remarks>
	/// This configurator is being used by both the legacy setup and the new prop centric intelligent fixture prop factory.
	/// </remarks>
	public class IntelligentFixtureNodeConfigurator
	{
		#region Fields
		...
		/// <summary>
		/// Configures a intelligent fixture node with properties.
		/// </summary>
        /// <param name="node">Vixen node to configure</param>
		/// <param name="fixtureName">Name of the fixture</param>
		...
		public ElementNode ConfigureFixtureNode(
            ElementNode node,
            string fixtureName,
