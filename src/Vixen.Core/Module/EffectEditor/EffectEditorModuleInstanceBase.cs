...
{
	public abstract class EffectEditorModuleInstanceBase : ModuleInstanceBase, IEffectEditorModuleInstance,
	                                                       IEqualityComparer<IEffectEditorModuleInstance>,
	                                                       IEquatable<IEffectEditorModuleInstance>,
	                                                       IEqualityComparer<EffectEditorModuleInstanceBase>,
	                                                       IEquatable<EffectEditorModuleInstanceBase>
	{
		public abstract IEffectEditorControl CreateEditorControl();
		...
		{
			return Equals(x, y as IEffectEditorModuleInstance);
		}
