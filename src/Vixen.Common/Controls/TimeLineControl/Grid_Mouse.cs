			...
			switch (m_mouseResizeZone) {
				case ResizeZone.Front:
					...
					if (AltPressed && adjoiningElements.Count() == 0)
					{
						...
						List<Element> priorElements = ActiveRow.GetPriorsOfElement(SelectedElements.First());
				...
				case ResizeZone.Back:
					...
					if (AltPressed && adjoiningElements.Count() == 0)
					{
						...
						List<Element> followElements = ActiveRow.GetFollowersOfElement(SelectedElements.First());
