...
namespace VixenModules.Editor.TimedSequenceEditor.Forms.WPF.MarksDocker.ViewModels
{
	public class MarkCollectionViewModel: ViewModelBase
	{
		...
		#region ShowTailGridLines property
		...
		{
			get { return GetValue<bool>(ShowTailGridLinesProperty); }
			set { SetValue(ShowTailGridLinesProperty, value); }
		}

		/// <summary>
		/// IsEnabled property data.
		/// </summary>
		public static readonly IPropertyData ShowTailGridLinesProperty = RegisterProperty<bool>(nameof(ShowTailGridLines));
		...
		public bool Locked
		{
			get { return GetValue<bool>(LockedProperty); }
		...
		/// ShowMarkBar property data.
		/// </summary>
		public static readonly IPropertyData LockedProperty = RegisterProperty<bool>(nameof(Locked));
