...
namespace VixenModules.Editor.TimedSequenceEditor
{
	public partial class TimedSequenceEditorForm : BaseForm, IEditorUserInterface, ITiming
	{
		...
		private void TimedSequenceEditorForm_Load(object sender, EventArgs e)
		{
			...
			moveCursorToSelectedEffectToolStripMenuItem.Checked = TimelineControl.grid.MoveCursorToSelectedEffect = xml.GetSetting(XMLProfileSettings.SettingType.AppSettings, string.Format("{0}/MoveCursorToSelectedEffect", Name), false);
