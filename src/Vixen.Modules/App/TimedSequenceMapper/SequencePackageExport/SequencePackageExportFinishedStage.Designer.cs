...
{
	partial class SequencePackageExportFinishedStage
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.lblFinished.Size = new System.Drawing.Size(143, 15);
			this.lblFinished.TabIndex = 0;
			this.lblFinished.Text = "Package Export Complete";
			// 
			// SequencePackageExportFinishedStage
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(7F, 15F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.lblFinished);
			this.Name = "SequencePackageExportFinishedStage";
