namespace VixenModules.App.Shows
{
	partial class ShowEditorForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tabControlShowItems = new TabControl();
			this.tabPageStartup = new TabPage();
			this.tabPageBackground = new TabPage();
			this.tabPageSequential = new TabPage();
			this.tabPageShutdown = new TabPage();
