...
- Decision: Make `Grid` the sole live `MarksMoving` subscriber that maintains Mark-derived snap points, while preserving the editor form's completed-operation rebuild.
