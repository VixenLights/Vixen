...
- [x] (2026-09-08 16:40Z) Completed manual Timed Sequence Editor validation: Wave and Liquid selectors correctly refresh for renamed, added, and removed Mark Collections without invalidating effects. The full Release/x64 build and all 917 unit tests pass.
...
2026-09-08 / User: Confirmed all manual Timed Sequence Editor scenarios pass, along with the full Release/x64 build and all 917 unit tests. Jira closeout remains outside this validation confirmation.
