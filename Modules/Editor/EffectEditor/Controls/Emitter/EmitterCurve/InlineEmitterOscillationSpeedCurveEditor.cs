...
{
	public class InlineEmitterOscillationSpeedCurveEditor : BaseInlineCurveEditor
	{
		#region Private Static Constructor

		private static readonly Type ThisType = typeof(InlineEmitterOscillationSpeedCurveEditor);

		#endregion

		#region Static Constructor

		static InlineEmitterOscillationSpeedCurveEditor()
		{
		...
		{
			var inlineCurveEditor = (InlineEmitterOscillationSpeedCurveEditor)d;
