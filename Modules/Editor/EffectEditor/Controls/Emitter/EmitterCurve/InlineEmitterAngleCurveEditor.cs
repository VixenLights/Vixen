...
{
	public class InlineEmitterAngleCurveEditor : BaseInlineCurveEditor
	{
		#region Private Static Fields

		private static readonly Type ThisType = typeof(InlineEmitterAngleCurveEditor);

		#endregion

		#region Static Constructor

		static InlineEmitterAngleCurveEditor()
		{
		...
		{
			var inlineCurveEditor = (InlineEmitterAngleCurveEditor)d;
