...
{
	public class InlineEmitterFlowCurveEditor : BaseInlineCurveEditor
	{
		#region Private Static Fields

		private static readonly Type ThisType = typeof(InlineEmitterFlowCurveEditor);

		#endregion

		#region Static Constructor

		static InlineEmitterFlowCurveEditor()
		{
		...
		{
			var inlineCurveEditor = (InlineEmitterFlowCurveEditor)d;
