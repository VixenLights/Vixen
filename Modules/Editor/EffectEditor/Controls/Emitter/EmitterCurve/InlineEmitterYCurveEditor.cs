...
{
	public class InlineEmitterYCurveEditor : BaseInlineCurveEditor
	{
		#region Private Static Fields

		private static readonly Type ThisType = typeof(InlineEmitterYCurveEditor);

		#endregion

		#region Static Constructor

		static InlineEmitterYCurveEditor()
		{
		...
		{
			var inlineCurveEditor = (InlineEmitterYCurveEditor)d;
