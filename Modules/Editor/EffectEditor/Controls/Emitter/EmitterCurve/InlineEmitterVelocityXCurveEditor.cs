...
{
	public class InlineEmitterVelocityXCurveEditor : BaseInlineCurveEditor
	{
		#region Private Static Fields

		private static readonly Type ThisType = typeof(InlineEmitterVelocityXCurveEditor);

		#endregion

		#region Static Constructor

		static InlineEmitterVelocityXCurveEditor()
		{
		...
		{
			var inlineCurveEditor = (InlineEmitterVelocityXCurveEditor)d;
