...
namespace VixenModules.Editor.ScriptEditor
{
	public partial class ProjectConfigForm : Form
	{
		...
		{
			IScriptModuleDescriptor[] scriptModuleDescriptors =
				Vixen.Services.ApplicationServices.GetModuleDescriptors<IScriptModuleInstance>().Cast<IScriptModuleDescriptor>().
					ToArray();
