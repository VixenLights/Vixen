namespace VixenModules.Output.Renard
{
	partial class SetupDialog {
		...
		private void InitializeComponent() {
			...
			// 
			this.comboBoxProtocolVersion.DrawMode = System.Windows.Forms.DrawMode.OwnerDrawFixed;
			...
			this.comboBoxProtocolVersion.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.comboBoxProtocolVersion.FormattingEnabled = true;
			this.comboBoxProtocolVersion.Items.AddRange(new object[] {
            "1",
            "2"});
			this.comboBoxProtocolVersion.Location = new System.Drawing.Point(121, 38);
			...
			this.comboBoxProtocolVersion.DrawItem += new System.Windows.Forms.DrawItemEventHandler(this.comboBox_DrawItem);
			// 
			// label1
			// 
			...
			this.buttonOK.Location = new System.Drawing.Point(55, 157);
			...
			this.ClientSize = new System.Drawing.Size(227, 205);
			this.Controls.Add(this.buttonCancel);
			this.Controls.Add(this.buttonOK);
			this.Controls.Add(this.groupBox1);
			this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedDialog;
			this.MaximizeBox = false;
			this.MaximumSize = new System.Drawing.Size(243, 244);
			this.MinimizeBox = false;
			this.MinimumSize = new System.Drawing.Size(243, 244);
