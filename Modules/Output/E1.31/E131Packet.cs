namespace VixenModules.Controller.E131
{
    ...
    public class E131Packet : E131Base
    {
        ...
        public override byte[] PhyBuffer
        {
            ...
            set
            {
                if (value.Length < E131Root.PHYBUFFER_SIZE + E131Framing.PHYBUFFER_SIZE + E131DeviceManagementProtocol.PHYBUFFER_BASE)
                {
                    return;
                }
        ...
        public ushort PhyLength
        {
            get
            {
                return (ushort)(E131Root.PHYBUFFER_SIZE + this.E131Framing.Length);
            }
        }
