...
namespace VixenModules.App.SimpleSchedule.Forms
{
	public partial class ConfigureSchedule : Form
	{
		...
		private CalendarItem contextItem;
		...
		private void addToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			if (item != null && item.Tag != null) {
				...
				item = new CalendarItem(calendar1, calendar1.SelectedElementStart.Date, calendar1.SelectedElementEnd.Date,
				                        "New Item to Add");
		...
		private void deleteToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			DialogResult result;
			if (item != null && item.Tag != null) {
				result = MessageBox.Show("Are you sure you want to delete item!!!", "Delete Item", MessageBoxButtons.YesNo,
				...
				//This is not a scheduled item so we can just remove it.
				if (item.Selected) {
