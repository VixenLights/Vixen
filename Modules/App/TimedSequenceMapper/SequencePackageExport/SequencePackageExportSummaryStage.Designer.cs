...
{
	partial class SequencePackageExportSummaryStage
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.mainLayoutPanel.Controls.Add(this.lblOutputFolder, 1, 3);
			this.mainLayoutPanel.Controls.Add(this.lblSummary, 0, 0);
			this.mainLayoutPanel.Controls.Add(this.lblSequences, 0, 2);
			this.mainLayoutPanel.Controls.Add(this.lblTaskProgress, 0, 7);
			this.mainLayoutPanel.Controls.Add(this.taskProgress, 0, 8);
			this.mainLayoutPanel.Controls.Add(this.lblDestination, 0, 3);
			this.mainLayoutPanel.Controls.Add(this.lblAudio, 0, 4);
			this.mainLayoutPanel.Controls.Add(this.lblOverallProgress, 0, 9);
			this.mainLayoutPanel.Controls.Add(this.lblSequenceCount, 1, 2);
			this.mainLayoutPanel.Controls.Add(this.overallProgress, 0, 11);
			this.mainLayoutPanel.Controls.Add(this.lblAudioOption, 1, 4);
			...
			this.lblOutputFolder.Location = new System.Drawing.Point(76, 50);
			this.lblOutputFolder.Name = "lblOutputFolder";
			this.lblOutputFolder.Size = new System.Drawing.Size(184, 15);
			...
			this.lblSummary.Size = new System.Drawing.Size(196, 15);
			this.lblSummary.TabIndex = 0;
			this.lblSummary.Text = "Export Sequence Package Summary";
			// 
			// lblSequences
			// 
			...
			this.lblAudio.Location = new System.Drawing.Point(3, 65);
			...
			this.lblSequenceCount.Location = new System.Drawing.Point(76, 35);
			...
			this.lblAudioOption.Location = new System.Drawing.Point(76, 65);
			...
			// 
			// SequencePackageExportSummaryStage
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(7F, 15F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.mainLayoutPanel);
			this.Name = "SequencePackageExportSummaryStage";
