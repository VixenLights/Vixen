namespace VixenModules.App.ExportWizard
{
	partial class BulkExportSummaryStage
	{
		...
		private void InitializeComponent()
		{
			...
			this.mainLayoutPanel.Controls.Add(this.lblTaskProgress, 0, 9);
			this.mainLayoutPanel.Controls.Add(this.taskProgress, 0, 10);
			...
			this.mainLayoutPanel.Controls.Add(this.lblOverallProgress, 0, 11);
			this.mainLayoutPanel.Controls.Add(this.lblSequenceCount, 1, 2);
			this.mainLayoutPanel.Controls.Add(this.overallProgress, 0, 13);
			this.mainLayoutPanel.Location = new System.Drawing.Point(3, 3);
			this.mainLayoutPanel.Name = "mainLayoutPanel";
			this.mainLayoutPanel.RowCount = 14;
