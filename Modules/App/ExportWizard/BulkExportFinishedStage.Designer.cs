...
{
	partial class BulkExportFinishedStage
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.lblFinished.Size = new System.Drawing.Size(95, 15);
			this.lblFinished.TabIndex = 0;
			this.lblFinished.Text = "Export Complete";
			// 
			// BulkExportFinishedStage
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(7F, 15F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.lblFinished);
			this.Name = "BulkExportFinishedStage";
