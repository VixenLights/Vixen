...
namespace VixenModules.Effect.Effect
{
	...
	/// </summary>
	/// <typeparam name="TInterface">Collection Item Interface type</typeparam>
	/// <typeparam name="TImpl">Collection concrete type</typeparam>
	public abstract class MarkCollectionExpandoObjectCollection<TInterface, TImpl> : ExpandoObjectObservableCollection<TInterface, TImpl>
		where TInterface : IMarkCollectionExpandoObject
		where TImpl : class, new()
	{
		...
		public MarkCollectionExpandoObjectCollection(string propertyName):
			base(propertyName)
		{
		}
