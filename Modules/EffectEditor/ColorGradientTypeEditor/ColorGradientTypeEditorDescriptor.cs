...
{
	internal class ColorGradientTypeEditorDescriptor : EffectEditorModuleDescriptorBase
	{
		...
		{
			get { return "A control which will edit a parameter of type ColorGradient."; }
		}
		...
		{
			get { return typeof (ColorGradientTypeEditor); }
		}
		...
		{
			get { return "ColorGradient Type Editor"; }
		}
		...
		{
			get { return new Guid[] {_ColorGradientsId}; }
		}
