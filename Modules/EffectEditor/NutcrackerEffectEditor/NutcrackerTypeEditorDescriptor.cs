...
{
	internal class NutcrackerTypeEditorDescriptor : EffectEditorModuleDescriptorBase
	{
		...
		{
			get { return "A control which will edit a Nutcracker Effect."; }
		}
		...
		{
			get { return typeof (NutcrackerTypeEditor); }
		}
		...
		{
			get { return "Nutcracker Type Editor"; }
		}
		...
		{
			get { return new[] {typeof (VixenModules.Effect.Nutcracker.NutcrackerData)}; }
		}
	}
}