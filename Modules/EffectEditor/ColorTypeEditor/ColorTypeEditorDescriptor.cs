...
{
	internal class ColorTypeEditorDescriptor : EffectEditorModuleDescriptorBase
	{
		...
		{
			get { return "A control which will edit a parameter of type Color."; }
		}
		...
		{
			get { return typeof (ColorTypeEditor); }
		}
