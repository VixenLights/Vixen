...
{
	internal class CurveTypeEditorDescriptor : EffectEditorModuleDescriptorBase
	{
		...
		{
			get { return "A control which will edit a parameter of type Curve."; }
		}
		...
		{
			get { return typeof (CurveTypeEditor); }
		}
