...
{
	internal class LevelTypeEditorDescriptor : EffectEditorModuleDescriptorBase
	{
		...
		{
			get { return "A control which will edit a parameter of type double."; }
		}
		...
		{
			get { return typeof (LevelTypeEditor); }
		}
