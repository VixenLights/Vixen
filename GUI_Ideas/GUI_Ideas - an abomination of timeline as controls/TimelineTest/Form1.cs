...
namespace Timeline
{
    public partial class Form1 : Form
	{
        ...
        public Form1()
        {
			...
			timelineControl1.AddRow("test row 1", 50);
			timelineControl1.AddRow("test row 2", 100);
			timelineControl1.AddRow("test row 3", 150);
			//timelineControl1.AddRow("test row 4", 200);
