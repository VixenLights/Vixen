...
namespace Timeline
{
	public partial class TimelineHeader : TimelineControlBase
	{
		...
		//        else
		//            // dodgy hack, but saves null checking elsewhere. What's the best way to do this, I wonder?
        ...
        {
            e.Graphics.FillRectangle(new SolidBrush(Color.Gray), 0, 0, Width, Height);
