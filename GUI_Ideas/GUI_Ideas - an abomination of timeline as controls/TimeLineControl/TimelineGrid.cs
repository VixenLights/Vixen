...
//		public TimelineControl ParentControl
		...
		public TimeSpan MajorGridlineInterval { get; set; }
		public Color MajorGridlineColor { get; set; }
		public Color RowSeparatorColor { get; set; }
		public Color SnapPointColor { get; set; }
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			int totalHeight = 0;
			foreach (TimelineRow row in Controls) {
		...
		protected override void OnLayout(LayoutEventArgs e)
		{
			...
			int currentHeight = 0;
			int totalPixelWidth = (int)timeToPixels(TotalTime);

			foreach (TimelineRow tr in Controls) {
				tr.Location = new Point(0, currentHeight);
				tr.Width = totalPixelWidth;
				currentHeight += tr.Height;
			}

			AutoScrollMinSize = new Size(totalPixelWidth, currentHeight);
		}
