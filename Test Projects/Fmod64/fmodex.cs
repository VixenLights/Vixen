...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int number = 0x00041804;
        //public const int number = 0x00042003;
    ...
    */
    ...
    {        
        public static RESULT System_Create(ref _System system)
        {
            ...
            _System      systemnew   = null;

            if (VERSION.platform == Platform.X64)
            {
                result = FMOD_System_Create_64(ref systemraw);
            }
            else
            {
                result = FMOD_System_Create_32(ref systemraw);
            }
    ...
    */
    public class _System
    {
        public RESULT release                ()
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_Release_64(systemraw);
            }
            else
            {
                return FMOD_System_Release_32(systemraw);
            } 
        }
        ...
        public RESULT getNumDrivers          (ref int numdrivers)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_GetNumDrivers_64(systemraw, ref numdrivers);
            }
            else
            {
                return FMOD_System_GetNumDrivers_32(systemraw, ref numdrivers);
            } 
        }
        public RESULT getDriverInfo          (int id, StringBuilder name, int namelen, ref GUID guid)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_GetDriverInfo_64(systemraw, id, name, namelen, ref guid);
            }
            else
            {
                return FMOD_System_GetDriverInfo_32(systemraw, id, name, namelen, ref guid);
            } 
        }
        ...
        public RESULT setDriver              (int driver)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_SetDriver_64(systemraw, driver);
            }
            else
            {
                return FMOD_System_SetDriver_32(systemraw, driver);
            } 
        }
        ...
        public RESULT setSoftwareFormat      (int samplerate, SOUND_FORMAT format, int numoutputchannels, int maxinputchannels, DSP_RESAMPLER resamplemethod)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_SetSoftwareFormat_64(systemraw, samplerate, format, numoutputchannels, maxinputchannels, resamplemethod);
            }
            else
            {
                return FMOD_System_SetSoftwareFormat_32(systemraw, samplerate, format, numoutputchannels, maxinputchannels, resamplemethod);
            }
        }
        public RESULT getSoftwareFormat      (ref int samplerate, ref SOUND_FORMAT format, ref int numoutputchannels, ref int maxinputchannels, ref DSP_RESAMPLER resamplemethod, ref int bits)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_GetSoftwareFormat_64(systemraw, ref samplerate, ref format, ref numoutputchannels, ref maxinputchannels, ref resamplemethod, ref bits);
            }
            else
            {
                return FMOD_System_GetSoftwareFormat_32(systemraw, ref samplerate, ref format, ref numoutputchannels, ref maxinputchannels, ref resamplemethod, ref bits);
            }
        }
        public RESULT setDSPBufferSize       (uint bufferlength, int numbuffers)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_SetDSPBufferSize_64(systemraw, bufferlength, numbuffers);
            }
            else
            {
                return FMOD_System_SetDSPBufferSize_32(systemraw, bufferlength, numbuffers);
            } 
        }
        ...
        public RESULT init                   (int maxchannels, INITFLAG flags, IntPtr extradata)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_Init_64(systemraw, maxchannels, flags, extradata);
            }
            else
            {
                return FMOD_System_Init_32(systemraw, maxchannels, flags, extradata);
            } 
        }
        public RESULT close                  ()
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_Close_64(systemraw);
            }
            else
            {
                return FMOD_System_Close_32(systemraw);
            } 
        }
        ...
        public RESULT update                 ()
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_Update_64(systemraw);
            }
            else
            {
                return FMOD_System_Update_32(systemraw);
            } 
        }
        ...
        public RESULT setStreamBufferSize    (uint filebuffersize, TIMEUNIT filebuffersizetype)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_SetStreamBufferSize_64(systemraw, filebuffersize, filebuffersizetype);
            }
            else
            {
                return FMOD_System_SetStreamBufferSize_32(systemraw, filebuffersize, filebuffersizetype);
            } 
        }
        ...
        public RESULT getSpectrum            (float[] spectrumarray, int numvalues, int channeloffset, DSP_FFT_WINDOW windowtype)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_System_GetSpectrum_64(systemraw, spectrumarray, numvalues, channeloffset, windowtype);
            }
            else
            {
                return FMOD_System_GetSpectrum_32(systemraw, spectrumarray, numvalues, channeloffset, windowtype);
            } 
        }
        ...
        public RESULT createSound            (string name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref Sound sound)
        {
            ...
            try
            {
                if (VERSION.platform == Platform.X64)
                {
                    result = FMOD_System_CreateSound_64(systemraw, name_or_data, mode, ref exinfo, ref soundraw);
                }
                else
                {
                    result = FMOD_System_CreateSound_32(systemraw, name_or_data, mode, ref exinfo, ref soundraw);
                } 
            }
            catch
            {
        ...
        public RESULT createSound            (byte[] data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref Sound sound)
        {
            ...
            try
            {
                if (VERSION.platform == Platform.X64)
                {
                    result = FMOD_System_CreateSound_64(systemraw, data, mode, ref exinfo, ref soundraw);
                }
                else
                {
                    result = FMOD_System_CreateSound_32(systemraw, data, mode, ref exinfo, ref soundraw);
                } 
            }
            catch
            {
        ...
        public RESULT createSound            (string name_or_data, MODE mode, ref Sound sound)
        {
            ...
            try
            {
                if (VERSION.platform == Platform.X64)
                {
                    result = FMOD_System_CreateSound_64(systemraw, name_or_data, mode, 0, ref soundraw);
                }
                else
                {
                    result = FMOD_System_CreateSound_32(systemraw, name_or_data, mode, 0, ref soundraw);
                } 
            }
            catch
            {
        ...
        public RESULT playSound              (CHANNELINDEX channelid, Sound sound, bool paused, ref Channel channel)
        {
            ...
            try
            {
                if (VERSION.platform == Platform.X64)
                {
                    result = FMOD_System_PlaySound_64(systemraw, channelid, sound.getRaw(), (paused ? 1 : 0), ref channelraw);
                }
                else
                {
                    result = FMOD_System_PlaySound_32(systemraw, channelid, sound.getRaw(), (paused ? 1 : 0), ref channelraw);
                } 
            }
            catch
            {
        ...
        [DllImport (VERSION.dll32,EntryPoint="FMOD_System_CreateSound", CharSet = CharSet.Unicode)]   
        ...
        [DllImport(VERSION.dll64, EntryPoint = "FMOD_System_CreateSound", CharSet = CharSet.Unicode)]
    ...
    */
    public class Sound
    {
        public RESULT release                 ()
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Sound_Release_64(soundraw);
            }
            else
            {
                return FMOD_Sound_Release_32(soundraw);
            } 
        }
        ...
        public RESULT @lock                   (uint offset, uint length, ref IntPtr ptr1, ref IntPtr ptr2, ref uint len1, ref uint len2)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Sound_Lock_64(soundraw, offset, length, ref ptr1, ref ptr2, ref len1, ref len2);
            }
            else
            {
                return FMOD_Sound_Lock_32(soundraw, offset, length, ref ptr1, ref ptr2, ref len1, ref len2);
            } 
        }
        public RESULT unlock                  (IntPtr ptr1,  IntPtr ptr2, uint len1, uint len2)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Sound_Unlock_64(soundraw, ptr1, ptr2, len1, len2);
            }
            else
            {
                return FMOD_Sound_Unlock_32(soundraw, ptr1, ptr2, len1, len2);
            } 
        }
        public RESULT setDefaults             (float frequency, float volume, float pan, int priority)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Sound_SetDefaults_64(soundraw, frequency, volume, pan, priority);
            }
            else
            {
                return FMOD_Sound_SetDefaults_32(soundraw, frequency, volume, pan, priority);
            } 
        }
        public RESULT getDefaults             (ref float frequency, ref float volume, ref float pan, ref int priority)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Sound_GetDefaults_64(soundraw, ref frequency, ref volume, ref pan, ref priority);
            }
            else
            {
                return FMOD_Sound_GetDefaults_32(soundraw, ref frequency, ref volume, ref pan, ref priority);
            } 
        }
        ...
        public RESULT getName                 (StringBuilder name, int namelen)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Sound_GetName_64(soundraw, name, namelen);
            }
            else
            {
                return FMOD_Sound_GetName_32(soundraw, name, namelen);
            } 
        }
        public RESULT getLength               (ref uint length, TIMEUNIT lengthtype)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Sound_GetLength_64(soundraw, ref length, lengthtype);
            }
            else
            {
                return FMOD_Sound_GetLength_32(soundraw, ref length, lengthtype);
            } 
        }
        public RESULT getFormat               (ref SOUND_TYPE type, ref SOUND_FORMAT format, ref int channels, ref int bits)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Sound_GetFormat_64(soundraw, ref type, ref format, ref channels, ref bits);
            }
            else
            {
                return FMOD_Sound_GetFormat_32(soundraw, ref type, ref format, ref channels, ref bits);
            } 
        }
    ...
    */
    public class Channel
    {
        ...
        public RESULT stop                  ()
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Channel_Stop_64(channelraw);
            }
            else
            {
                return FMOD_Channel_Stop_32(channelraw);
            }
        }
        public RESULT setPaused             (bool paused)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Channel_SetPaused_64(channelraw, (paused ? 1 : 0));
            }
            else
            {
                return FMOD_Channel_SetPaused_32(channelraw, (paused ? 1 : 0));
            }
        }
        public RESULT getPaused             (ref bool paused)
        {
            ...
            if (VERSION.platform == Platform.X64)
            {
                result = FMOD_Channel_GetPaused_64(channelraw, ref p);
            }
            else
            {
                result = FMOD_Channel_GetPaused_32(channelraw, ref p);
            } 
        ...
        public RESULT setVolume             (float volume)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Channel_SetVolume_64(channelraw, volume);
            }
            else
            {
                return FMOD_Channel_SetVolume_32(channelraw, volume);
            }
        }
        public RESULT getVolume             (ref float volume)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Channel_GetVolume_64(channelraw, ref volume);
            }
            else
            {
                return FMOD_Channel_GetVolume_32(channelraw, ref volume);
            } 
        }
        public RESULT setFrequency          (float frequency)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Channel_SetFrequency_64(channelraw, frequency);
            }
            else
            {
                return FMOD_Channel_SetFrequency_32(channelraw, frequency);
            }
        }
        public RESULT getFrequency          (ref float frequency)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Channel_GetFrequency_64(channelraw, ref frequency);
            }
            else
            {
                return FMOD_Channel_GetFrequency_32(channelraw, ref frequency);
            } 
        }
        ...
        public RESULT setPosition           (uint position, TIMEUNIT postype)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Channel_SetPosition_64(channelraw, position, postype);
            }
            else
            {
                return FMOD_Channel_SetPosition_32(channelraw, position, postype);
            }
        }
        public RESULT getPosition           (ref uint position, TIMEUNIT postype)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Channel_GetPosition_64(channelraw, ref position, postype);
            }
            else
            {
                return FMOD_Channel_GetPosition_32(channelraw, ref position, postype);
            } 
        }
        ...
        public RESULT isPlaying             (ref bool isplaying)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_Channel_IsPlaying_64(channelraw, ref isplaying);
            }
            else
            {
                return FMOD_Channel_IsPlaying_32(channelraw, ref isplaying);
            } 
        }
    ...
    */
    public class ChannelGroup
    {
        ...
        public RESULT setVolume              (float volume)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_ChannelGroup_SetVolume_64(channelgroupraw, volume);
            }
            else
            {
                return FMOD_ChannelGroup_SetVolume_32(channelgroupraw, volume);
            }
        }
        public RESULT getVolume              (ref float volume)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_ChannelGroup_GetVolume_64(channelgroupraw, ref volume);
            }
            else
            {
                return FMOD_ChannelGroup_GetVolume_32(channelgroupraw, ref volume);
            } 
        }
        ...
        public RESULT setPaused              (bool paused)
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_ChannelGroup_SetPaused_64(channelgroupraw, (paused ? 1 : 0));
            }
            else
            {
                return FMOD_ChannelGroup_SetPaused_32(channelgroupraw, (paused ? 1 : 0));
            } 
        }
        public RESULT getPaused              (ref bool paused)
        {
            ...
            if (VERSION.platform == Platform.X64)
            {
                result = FMOD_ChannelGroup_GetPaused_64(channelgroupraw, ref p);
            }
            else
            {
                result = FMOD_ChannelGroup_GetPaused_32(channelgroupraw, ref p);
            } 
        ...
        public RESULT stop                   ()
        {
            if (VERSION.platform == Platform.X64)
            {
                return FMOD_ChannelGroup_Stop_64(channelgroupraw);
            }
            else
            {
                return FMOD_ChannelGroup_Stop_32(channelgroupraw);
            } 
        }
