...
namespace TestEditor {
    public partial class ManualPatch : Form {
        public ManualPatch(OutputController[] controllers, Fixture[] fixtures) {
            InitializeComponent();
            ...
            comboBoxFixture.DataSource = fixtures;
        }
        ...
        private void buttonPatch_Click(object sender, EventArgs e) {
            if(comboBoxController.SelectedItem != null &&
                comboBoxFixture.SelectedItem != null &&
