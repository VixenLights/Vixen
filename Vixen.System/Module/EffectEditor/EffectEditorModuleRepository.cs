...
{
	internal class EffectEditorModuleRepository : IModuleRepository<IEffectEditorModuleInstance>
	{
		// Effect type id : effect editor
		private Dictionary<Guid, IEffectEditorModuleInstance> _effectEditorEffectIndex =
			new Dictionary<Guid, IEffectEditorModuleInstance>();

		// Effect signature : effect editor
		private Dictionary<int, IEffectEditorModuleInstance> _effectEditorSignatureIndex =
			new Dictionary<int, IEffectEditorModuleInstance>();
