...
namespace Vixen.Sys.Managers {
	class OutputDeviceExecution<T> : IOutputDeviceExecution<T>
		...
		private bool _InRunningState {
			get { return ExecutionState == ExecutionState.Starting || ExecutionState == ExecutionState.Started || ExecutionState == ExecutionState.Paused; }
		}
