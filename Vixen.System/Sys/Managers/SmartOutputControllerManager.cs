...
namespace Vixen.Sys.Managers {
	public class SmartOutputControllerManager : IControllerManager<SmartOutputController>, IControllerFacadeParticipant {
		...
		internal SmartOutputControllerManager(IControllerLinkManager<SmartOutputController> linkManager, IOutputDeviceCollection<SmartOutputController> deviceCollection, IOutputDeviceExecution<SmartOutputController> deviceExecution) {
