...
namespace Vixen.Sys.Managers {
	public class OutputControllerManager : IControllerManager<OutputController>, IControllerFacadeParticipant {
		...
		internal OutputControllerManager(IControllerLinkManager<OutputController> linkManager, IOutputDeviceCollection<OutputController> deviceCollection, IOutputDeviceExecution<OutputController> deviceExecution) {
		...
		public IDataFlowComponent GetDataFlowComponentForOutput(IOutputDevice controller, int outputIndex) {
			return GetDataFlowComponentForOutput((OutputController)controller, outputIndex);
		}
		...
		public void StartOnly(IEnumerable<IOutputDevice> outputDevices) {
			StartAll(outputDevices.Cast<OutputController>());
		}
