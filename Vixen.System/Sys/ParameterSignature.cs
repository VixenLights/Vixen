...
namespace Vixen.Sys
{
	...
	{
		private ParameterSpecification[] _parameters;
		...
		public ParameterSignature(string commandParameters)
		{
			...
			foreach (
				string parameterString in
					commandParameters.Split(new[] {PARAMETER_DELIMITER}, StringSplitOptions.RemoveEmptyEntries)) {
