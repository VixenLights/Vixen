...
namespace Vixen.Services {
	public class ElementNodeService {
		static private ElementNodeService _instance;
		...
		public ElementNode CreateSingle(ElementNode parentNode, string name = null, bool createElement = true, bool uniquifyName = true, int index = -1) {
			name = name ?? "Unnamed";
		...
		public ElementNode[] CreateMultiple(ElementNode parentNode, int count, bool createElement = true, bool uniquifyNames = true) {
