...
namespace Vixen.Intent {
	public class LinearIntent<TypeOfValue> : Dispatchable<LinearIntent<TypeOfValue>>, IIntent<TypeOfValue>
		...
		public LinearIntent(TypeOfValue startValue, TypeOfValue endValue, TimeSpan timeSpan, Interpolator<TypeOfValue> interpolator = null)
		...
		private LinearIntent(TypeOfValue startValue, TypeOfValue endValue, TimeSpan timeSpan, LinearInterpolatedIntentSegmentCollection<TypeOfValue> segments)
			: this(startValue, endValue, timeSpan) {
			_segments = segments;
		}
		...
		public IIntent[] DivideAt(TimeSpan intentRelativeTime) {
			...
			LinearIntent<TypeOfValue> leftIntent = new LinearIntent<TypeOfValue>(StartValue, dividePointValue, intentRelativeTime, leftSegments);
			LinearIntent<TypeOfValue> rightIntent = new LinearIntent<TypeOfValue>(dividePointValue, EndValue, TimeSpan - intentRelativeTime, rightSegments);
