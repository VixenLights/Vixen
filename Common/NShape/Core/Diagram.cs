...
namespace Dataweb.NShape
{
	...
	public sealed class Diagram : IEntity, ISecurityDomainObject
	{
		...
		public Image CreateImage(ImageFileFormat imageFormat, IEnumerable<Shape> shapes, int margin, bool withBackground,
		...
		public void DrawBackground(Graphics graphics, Rectangle clipRectangle)
		{
			...
			if (!NamedImage.IsNullOrEmpty(backImage)) {
				...
				if (imageAttribs == null)
					imageAttribs = GdiHelpers.GetImageAttributes(imageLayout, imageGamma, imageTransparency, imageGrayScale, false,
