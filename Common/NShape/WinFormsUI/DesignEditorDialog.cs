...
namespace Dataweb.NShape.WinFormsUI
{
	...
	public partial class DesignEditorDialog : Form
	{
		...
		private void deleteDesignButton_Click(object sender, EventArgs e)
		{
			if (
				MessageBox.Show(
					"All styles in this design will be lost." + Environment.NewLine + "Do you really want do to delete this design?",
					"Delete Design", MessageBoxButtons.YesNo) == DialogResult.Yes)
		...
		{
			if (MessageBox.Show("Do you really want do to delete this style?", "Delete Style", MessageBoxButtons.YesNo) ==
			    DialogResult.Yes)
