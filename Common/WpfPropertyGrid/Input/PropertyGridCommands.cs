...
namespace System.Windows.Controls.WpfPropertyGrid
{
	...
	public static class PropertyGridCommands
	{
		...
		private static readonly RoutedUICommand _HideReadOnlyProperties = new RoutedUICommand("Hide Read-Only Properties",
			"HideReadOnlyProperties", ThisType);

		private static readonly RoutedUICommand _ToggleReadOnlyProperties = new RoutedUICommand(
			"Toggle Read-Only Properties", "ToggleReadOnlyProperties", ThisType);

		private static readonly RoutedUICommand _ShowAttachedProperties = new RoutedUICommand("Show Attached Properties",
			"ShowAttachedProperties", ThisType);

		private static readonly RoutedUICommand _HideAttachedProperties = new RoutedUICommand("Hide Attached Properties",
			"HideAttachedProperties", ThisType);

		private static readonly RoutedUICommand _ToggleAttachedProperties = new RoutedUICommand("Toggle Attached Properties",
			"ToggleAttachedProperties", ThisType);
		...
		/// </summary>
		public static RoutedUICommand HideFilter
		{
		...
		/// </summary>
		public static RoutedUICommand ToggleFilter
		{
		...
		/// </summary>
		public static RoutedUICommand ResetFilter
		{
			get { return _ResetFilter; }
		}
		...
		/// </summary>
		public static RoutedUICommand ShowReadOnlyProperties
		{
		...
		/// </summary>
		public static RoutedUICommand HideReadOnlyProperties
		{
			get { return _HideReadOnlyProperties; }
		}

		/// <summary>
		/// Represents a command for the control to toggle visibility of read-only properties.
		/// </summary>
		public static RoutedUICommand ToggleReadOnlyProperties
		{
			get { return _ToggleReadOnlyProperties; }
		}

		/// <summary>
		/// Represents a command for the control to show all attached properties.
		/// </summary>
		public static RoutedUICommand ShowAttachedProperties
		{
			get { return _ShowAttachedProperties; }
		}

		/// <summary>
		/// Represents a command for the control to hide all attached properties.
		/// </summary>
		public static RoutedUICommand HideAttachedProperties
		{
			get { return _HideAttachedProperties; }
		}

		/// <summary>
		/// Represents a command for the control to toggle visibility of attached properties.
		/// </summary>
		public static RoutedUICommand ToggleAttachedProperties
		{
			get { return _ToggleAttachedProperties; }
		}
