...
namespace System.Windows.Controls.WpfPropertyGrid
{
  ...
  using Controls;
  /// <summary>
  /// PropertyEditorGrid control.
  /// </summary>
  public partial class PropertyEditorGrid : Control, INotifyPropertyChanged
  {
	...
	private void OnTypeDescriptorRefreshed(RefreshEventArgs e)
	{
		...
		{
			Dispatcher.Invoke(new RefreshEventHandler(this.OnTypeDescriptorRefreshedInvoke), new object[] { e });
		}
		else
		{
	...
	private void OnTypeDescriptorRefreshedInvoke(RefreshEventArgs e)
	{
		if (currentObjects != null)
		{
			for (int i = 0; i < currentObjects.Length; i++)
			{
				...
				if (currentObjects[i] == e.ComponentChanged || typeChanged != null && typeChanged.IsInstanceOfType(currentObjects[i]))
				{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PropertyEditorGrid"/> class.
    /// </summary>
    public PropertyEditorGrid()
    {
		EventManager.RegisterClassHandler(typeof(PropertyEditorGrid), GotFocusEvent, new RoutedEventHandler(ShowDescription), true);
    ...
    public static readonly DependencyProperty CurrentDescriptionProperty =
        DependencyProperty.Register("CurrentDescription", typeof(string), typeof(PropertyEditorGrid),
    ...
    {
      ((PropertyEditorGrid)d).OnCurrentDescriptionChanged(e);
    }
    ...
    /// </summary>
    /// <remarks>
    /// This event is intended to be used in customization scenarios. It is not used by PropertyEditorGrid control directly.
    /// </remarks>
    ...
    {
      var pg = (PropertyEditorGrid)sender;
    ...
    {
      var propertyGrid = (PropertyEditorGrid)sender;
