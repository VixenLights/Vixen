...
namespace System.Windows.Controls.WpfPropertyGrid.Editors
{
	...
	public abstract class Editor : DependencyObject
	{
		...
		public static readonly DependencyProperty InlineTemplateProperty =
			DependencyProperty.Register("InlineTemplate", typeof (object), ThisType, new PropertyMetadata(null),
		...
		public static readonly DependencyProperty ExtendedTemplateProperty =
			DependencyProperty.Register("ExtendedTemplate", typeof (object), ThisType, new PropertyMetadata(null),
				ValidateTemplateValue);
		...
		public static readonly DependencyProperty DialogTemplateProperty =
			DependencyProperty.Register("DialogTemplate", typeof (object), ThisType, new PropertyMetadata(null),
				ValidateTemplateValue);
