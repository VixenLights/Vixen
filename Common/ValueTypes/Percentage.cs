...
namespace Common.ValueTypes {
	...
	public struct Percentage : IEquatable<Percentage> {
		...
		static public implicit operator float(Percentage percentage) {
			return percentage.Value;
		}

		static public implicit operator Percentage(float value) {
			return new Percentage(value);
		}

		static public implicit operator double(Percentage percentage) {
			return percentage.Value;
		}

		static public implicit operator Percentage(double value) {
